...
class Mouse:
    ...
    def __init__(self, seconds: int):
        ...
        # Start timer
        timer_thread = threading.Thread(target=self.thread_sleep, args=(seconds,))
        timer_thread.start()
    ...
    def use_data(self):
        ...
        use_left_thread = threading.Thread(target=self.use_left_data, args=())
        use_right_thread = threading.Thread(target=self.use_right_data, args=(0,))

        use_left_thread.start()
        use_right_thread.start()

    def use_left_data(self, training_data: Optional[pd.DataFrame] = False):
        i = 0
    ...
    def use_right_data(self, training_data: Optional[pd.DataFrame] = False):
        i = 0
    ...
    def thread_sleep(self, seconds: int):
